...
func (*Artist) Descriptor() ([]byte, []int) {
	return fileDescriptor_artist_e8abb804c4832ea5, []int{0}
}
...
func (*SimpleArtistRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_artist_e8abb804c4832ea5, []int{1}
}
...
type ArtistServiceClient interface {
	Get(ctx context.Context, in *SimpleArtistRequest, opts ...grpc.CallOption) (*Artist, error)
...
func (c *artistServiceClient) Get(ctx context.Context, in *SimpleArtistRequest, opts ...grpc.CallOption) (*Artist, error) {
	out := new(Artist)
	err := c.cc.Invoke(ctx, "/no.sysco.middleware.grpc.ArtistService/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ArtistServiceServer interface {
	Get(context.Context, *SimpleArtistRequest) (*Artist, error)
...
func _ArtistService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/no.sysco.middleware.grpc.ArtistService/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArtistServiceServer).Get(ctx, req.(*SimpleArtistRequest))
	}
...
func init() { proto.RegisterFile("schema/artist.proto", fileDescriptor_artist_e8abb804c4832ea5) }

var fileDescriptor_artist_e8abb804c4832ea5 = []byte{
	// 277 bytes of a gzipped FileDescriptorProto
	,
}
